...
const strings: Record<string, TranslationEntry> = {
  ...
  error_no_cached_data: {
    en: 'No data found. Browse the relevant page in-game first.',
    ja: 'データが見つかりません。まずゲーム内の該当ページを開いてください。'
  },
  error_stale_data: {
    en: 'This data has expired. Visit the page in-game to refresh it.',
    ja: 'データの有効期限が切れました。ゲーム内でページを開いて更新してください。'
  },
  error_no_character_stats: {
    en: 'No character stats found. Browse character pages in-game first.',
    ja: 'キャラクターのデータが見つかりません。まずゲーム内のキャラクターページを開いてください。'
  },
  ...
  error_request_failed: {
    ...
    ja: 'サーバーに接続できませんでした。再度お試しください。'
  },
  error_server_error: {
    en: 'Server error. Please try again.',
    ja: 'サーバーエラーが発生しました。再度お試しください。'
  },
  ...
  profile_clear_cache: {
    en: 'Clear captured data',
    ja: 'キャプチャデータを削除'
  },
  profile_show_disclaimer: {
  ...
  filter_enable_sync_desc: {
    en: 'Previously imported items that are no longer in your game inventory will also be deleted on granblue.team',
    ja: '以前インポートしたアイテムがゲーム内に存在しない場合、granblue.teamからも削除されます'
  },
  filter_hidden_rarity: {
    en: '{count} items hidden by rarity filter',
    ja: 'レアリティフィルターにより{count}件非表示'
  },
  filter_hidden_lv1: {
    en: '{count} items hidden because they are Level 1',
    ja: 'レベル1のため{count}件非表示'
  },
  filter_hidden_both: {
    en: '{count} items hidden by rarity filter and Level 1',
    ja: 'レアリティフィルターとレベル1により{count}件非表示'
  },
  ...
  // Empty states
  empty_party: {
    en: 'Browse a party in game to capture data',
    ja: 'ゲーム内で編成を閲覧するとデータがキャプチャされます'
  },
  empty_collection: {
    en: 'Browse your collection pages to capture data',
    ja: 'コレクションページを閲覧するとデータがキャプチャされます'
  },
  empty_database: {
    en: 'Browse detail pages to capture data',
    ja: '詳細ページを閲覧するとデータがキャプチャされます'
  },
  ...
  char_stats_no_captured: {
    en: 'No character stats captured',
    ja: 'キャラクターステータスがキャプチャされていません'
  },
  char_stats_no_stats: {
    en: 'No stats captured',
  ...
  sync_modal_body: {
    en: 'This will sync your entire collection with granblue.team.',
    ja: 'コレクション全体をgranblue.teamと同期します。'
  },
  sync_modal_warning: {
    en: 'Items removed from your collection will cause any teams using them to show as "orphaned".',
    ja: 'コレクションから削除されたアイテムは、それを使用している編成が「孤立」として表示されるようになります。'
  },
  sync_no_deletions: {
    en: 'No items will be removed.',
    ja: '削除されるアイテムはありません。'
  },
  sync_delete_count: {
    en: '{count} item will be removed:',
    ja: '{count}件のアイテムが削除されます：'
  },
  sync_delete_count_plural: {
    en: '{count} items will be removed:',
    ja: '{count}件のアイテムが削除されます：'
  },
  ...
  conflict_modal_message: {
    en: 'This item has no tracking ID in your collection. Importing will update the existing entry.',
    ja: 'このアイテムにはコレクション内のトラッキングIDがありません。インポートすると既存のエントリが更新されます。'
  },
  conflict_skip: { en: 'Skip', ja: 'スキップ' },
  conflict_skip_all: { en: 'Skip All', ja: 'すべてスキップ' },
  conflict_import_all: { en: 'Import All', ja: 'すべてインポート' },
  conflict_decided: {
    en: '{count} / {total} decided',
    ja: '{count} / {total} 決定済み'
  },
  ...
  toast_review_conflicts: {
    en: 'Review conflicts before importing',
    ja: 'インポート前に競合を確認してください'
  },
  toast_opening_party: {
    en: 'Opening party...',
    ja: 'パーティを開いています...'
  ...
  toast_imported_items: {
    en: 'Imported {total} items',
    ja: '{total}件をインポートしました'
  },
  toast_items_need_review: {
    en: '{count} items need review',
    ja: '{count}件のアイテムの確認が必要です'
  },
  toast_item_needs_review: {
  ...
  toast_data_captured: {
    en: '{name} data captured!',
    ja: '{name}のデータをキャプチャしました！'
  },

  // Update banner
  update_available: {
    en: 'A new version is available (v',
    ja: '新しいバージョンがあります（v'
  },
